...
public class AlbumController {
	...
	public ModelAndView PayPage(String[] selAl, @RequestParam(value = "checkPage", defaultValue = "albumPage") String checkPage,HttpSession session, RedirectAttributes ra) {
		ModelAndView mav = new ModelAndView();
		...
		if (mid == null) {
			...
			for (String al : selAl) {
				...
				/*if(checkPage.equals("albumPage")) {
					int totalPrice = Integer.parseInt(alqty)*alInfo.getAlsaleprice();
