					...
					<div class="card mb-4">
						<div class="BlogDiv" style="display: flex;">
							<c:if test="${BlogListMap.BGIMG != null }">
								<div class="BlogImg">
									<a href="/BlogInfoPage?bgcode=${BlogListMap.BGCODE}"> <img class="" src="${BlogListMap.BGIMG}" alt="..." style="width: 350px; height: 300p object-fit: cover;" />
									</a>
								</div>
							</c:if>
							<c:if test="${BlogListMap.BGIMG == null }">
								<div class="BlogImg">
									<a href="/BlogInfoPage?nwcode=${BlogListMap.BGCODE}"> <img class="" src="https://dummyimage.com/200x200/c1e3cd/ffffff.jpg" style="width: 350px; height: 300px; object-fit: cover;" alt="..." />
									</a>
								</div>
							</c:if>
							<div class="BlogText" style="flex: 1;">
								...
								<div class="small text-mute m-2" style="display: flex; justify-content: space-between; align-items: flex-end;">
									<!-- ---------------------------------------------------------------------------- -->
									<a class="Views" style="text-decoration-line: none; color: gray;">작성자: ${BlogListMap.BGWRITER}</a> <a class="Views" style="text-decoration-line: none; color: gray;">조회수: ${BlogListMap.BGBIGHIT}</a> <a class="Views" style="text-decoration-line: none; color: gray;">${BlogListMap.BGDATE}</a>
									<div class="like_article" onclick="like('${BlogListMap.BGCODE}')">
										<a href="#" class="prdLike"> <img alt="" src="/resources/assets/heart.png" style="width: 30px;">
										</a>
									</div>
								</div>
							</div>
