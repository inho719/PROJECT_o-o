			...
			<div class="col-lg-8">
				...
				<div class="card m-2">
					<div class="row">
						...
						<div class="col-md-2">
							<img alt="음원포스터" src="http://t1.daumcdn.net/friends/prod/editor/dc8b3d02-a15a-4afa-a88b-989cf2a50476.jpg" style="width: 100%;">
						</div>
						<div class="col-md-4">
							<div class="card m-2 pt-2 ps-2" style="width: 30%; display: -webkit-inline-box;">
								<p>asdf</p>
							</div>
							<div class="card m-2 pt-2 ps-2" style="width: 30%; display: -webkit-inline-box;">
								<p>asdf</p>
