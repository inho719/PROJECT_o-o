											...
											<div class="card-body d-flex">
												<div class="card-img d-flex">
													<img alt="" class="me-5" style="width: 35%;"
														...
														style="font-size: 35px; position: absolute; right: 123px;"></i></a>
													<div class="card-text card-body text-lg-center"
														style="padding: 0px; height: 94px; overflow: hidden;">
														<a>${pl.SGTITLE }</a> <br> <a>${pl.SGARTIST } </a>
													</div>
							...
							<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
								...
								<div class="carousel-item active" data-bs-interval="2000">
									...
									<div class="carousel-item" data-bs-interval="2000">
										<a href="https://www.music-flo.com/purchase/skt" target="_blank">
									...
									<div class="carousel-item" data-bs-interval="2000">
										<a href="https://www.lguplus.com/pogg/main/prod-detail?dispProdNo=1052" target="_blank">
