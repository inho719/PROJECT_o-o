		...
		<c:forEach items="${AlbumInfoList}" var="AlbumInfoList">
			<div>
				<div class="row">
					...
					<c:if test="${AlbumInfoList.alimg != null }">
							<div class="AlbumImg">
								<img class="" src="${AlbumInfoList.alimg}" alt="..." />
							</div>
						</c:if>
						<c:if test="${AlbumInfoList.alimg == null }">
							<div class="AlbumImg">
					...
					<div class="card col-md-8 mb-4">
						<p>${AlbumInfoList.alartist}</p>
						<p>${AlbumInfoList.alinfo}</p>
						<p>${AlbumInfoList.aldate}</p>
					</div>
			...
			<div class="card col-md-12 mb-2">${AlbumInfoList.allist}</div>

			<div>
				<div class="row">
					<div class="card col-md-8 mb-2">
						<div class="card mb-2 mt-2">${AlbumInfoList.alprice}</div>
						<div class="card mb-2">${AlbumInfoList.alsaleprice}</div>	
					</div>
					<div class="card col-md-4 mb-2 " style="display: inline-block;">
						<div>
							<button class="button mb-4 mt-4"
								onclick="location.href='CartPage.jsp'">바로가기</button>
						</div>
						<div>
