   ...
   <table>
        ...
        <%
            ...
            try{
                ...
                String allRequest = "select count(num) as cnt from airpods"+dbWhere+dbOrder;
                ...
                allRequest = "select "+requestSelect+" from airpods"+dbWhere+dbOrder;
                pstmt = conn.prepareStatement(allRequest);
...
<td>
    <table>
        ...
        <tr>
            <td align="center"><img src="image/airpods<%= rs.getString("num") %>.jpg" width="72" height="48"></td>
        </tr>
        <tr>
            <td><a href="airpodsdetail.jsp?num=<%= rs.getString("num") %>&name=<%= rs.getString("name") %>&MaxUseTime=<%= rs.getString("MaxUseTime") %>&Maker=<%= rs.getString("Maker") %>&Height=<%= rs.getString("Height") %>&Width=<%= rs.getString("Width") %>&Weight=<%= rs.getString("Weight") %>&Chip=<%= rs.getString("Chip") %>&Price=<%= rs.getString("Price") %>"><%= rs.getString("name") %></a></td>
        </tr>
       
        <tr>
            <td align="center">무게:<%= rs.getInt("Weight") %></td>
        </tr>
        <tr>
            <td align="center">칩:<%= rs.getString("Chip") %></td>
        </tr>
        <tr>
            <td align="center">블루투스:<%= rs.getString("Bluetooth") %> GB</td>
        </tr>
        <tr>
            <td align="center">최대사용시간:<%= rs.getString("MaxUseTime") %> GB</td>
        </tr>
        <tr>
