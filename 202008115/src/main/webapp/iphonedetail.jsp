...
<body>
    ...
    <div class="container">
        <div class="product-details">
            ...
            <img src="image/iphone<%= request.getParameter("num") %>.jpg" class="img-fluid" alt="Product Image">
            ...
            <p>SSD: <%= request.getParameter("SSD") %>GB</p>
            <p>RAM: <%= request.getParameter("RAM") %>GB</p>
