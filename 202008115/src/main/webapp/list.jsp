...
<body>
	<br>
	<h2 align="center" style="margin-top: 10px;">Think different</h2>
	<table>
		<thead>
		...
		<tbody>
			...
			<td>
				<table>
					...
					<tr>
						<td align="center">램:<%=rs.getString("RAM")%> GB
						</td>
					</tr>
					<tr>
						<td align="right"><b>가격:<%=rs.getString("Price")%> 원
						</b></td>
					</tr>
				</table>
			</td>
